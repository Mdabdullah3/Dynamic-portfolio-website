            ...
            <nav className="text-primary-foreground py-4 relative z-50 w-11/12 mx-auto uppercase text-[16px] tracking-wide font-semibold border-b border-primary-foreground/20">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4 ">
                        ...
                        <button className="bg-primary-foreground text-muted flex items-center px-6 py-3 shadow rounded hover:bg-white hover:text-[#465AE9] transition-colors font-bold uppercase">
                            Get Start Free
